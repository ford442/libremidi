...
EM_BOOL OnKeyboardEvent(int emsc_type, const EmscriptenKeyboardEvent* evt){
if (evt->shiftKey){
...
int main(){
  emscripten_set_mousedown_callback_on_thread("#canvas",0,1,OnMouseEvent,EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
emscripten_set_mouseup_callback_on_thread("#canvas",0,1,OnMouseEvent,EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
emscripten_set_keydown_callback_on_thread("#canvas",0,1,OnKeyboardEvent,EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
emscripten_set_keyup_callback_on_thread("#canvas",0,1,OnKeyboardEvent,EM_CALLBACK_THREAD_CONTEXT_CALLING_THREAD);
EM_ASM({
FS.mkdir("/snd");
FS.mkdir("/shader");
});
