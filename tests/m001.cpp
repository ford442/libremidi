...
if(com==3){
outpu.send_message(std::vector<unsigned char>{0x90,kll,127});
mouseLPressed=mouseLPressed+1;
}
if(com==2){
outpu.send_message(std::vector<unsigned char>{0x80,kll,100});
mouseLPressed=mouseLPressed-1;
}
if(com==1){
for (ll=48;ll<83;ll++){
...
vertices[(a*6)+2]=b*0.001;
vertices[(a*6)+3]=1.0f;
vertices[(a*6)+4]=white;
vertices[(a*6)+5]=1.0f-b*0.01;
};
vertices[7]=-0.5f;
vertices[1]=-0.5f;
vertices[13]=0.7f;
