...
return e->keyCode==DOM_VK_F2||e->keyCode==DOM_VK_F3||e->keyCode==DOM_VK_F4||e->keyCode==DOM_VK_F5||e->keyCode==DOM_VK_F6||e->keyCode==DOM_VK_F8||e->keyCode==DOM_VK_F9||e->keyCode==DOM_VK_F10||e->keyCode==DOM_VK_F11||e->keyCode==DOM_VK_F12||e->keyCode==DOM_VK_F1||e->keyCode==DOM_VK_BACK_SPACE||(e->keyCode>=DOM_VK_F1&&e->keyCode<=DOM_VK_F24)||e->ctrlKey||e->altKey||eventType==EMSCRIPTEN_EVENT_KEYPRESS||eventType||eventType==EMSCRIPTEN_EVENT_KEYUP;
}

static EM_BOOL key_callback(int eventType,const EmscriptenKeyboardEvent *e,void *userData){
int dom_pk_code=emscripten_compute_dom_pk_code(e->code);
if(e->repeat==true){return true;}
if(e->keyCode==32){midd(m1,0,1);return true;}
mouseLPressed=mouseLPressed+1;
...
if(e->keyCode==118){kkey=70;k=53;midd(m1,k,3);return true;/*noteOnGL(kkey);*/}
