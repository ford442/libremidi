...
if(e->keyCode==116){kkey=kkey+50;midd(m1,55,3);
}
if(e->keyCode==117){kkey=kkey+68;midd(m1,54,3);
}
// if(e->keyCode==118){kkey=70;k=53;midd(m1,k,3);}
if(e->which==118){kkey=kkey+70;midd(m1,53,3);
}
if(e->keyCode==119){kkey=kkey+80;midd(m1,52,3);
}
